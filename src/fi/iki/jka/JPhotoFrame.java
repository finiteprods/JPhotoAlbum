...
public class JPhotoFrame extends JFrame
    ...
    // extracted method
    // give it package visibility so it's still testable
    // not ideal but better than making it public!
    // better idea might be to extract a class, implementing an interface
    void slideShow() {
        if (photos.getSize()>0) {
